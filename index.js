...
app.get("/", (req, res) => {
  res.json({
    message: "This is a server for get waifu pics. All rights reserved for ® HyNO\n\nApi Help:\sfw Category: waifu , neko , shinobu , bully , cry , hug , kiss , lick , pat , smug , highfive , nom , bite , slap , wink , poke , dance , cringe , blush , happy\nsfw Category: waifu , neko , trap , blowjob\n\sfw example: https://api-hyno-waifu.vercel.app/sfw/waifu\nsfw example: https://api-hyno-waifu.vercel.app/nsfw/waifu",
  });
});
